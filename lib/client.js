window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var battle_stage_module_css_default = {
			...
			"ready": "R6dNhq_ready",
			"silhouetteReady": "R6dNhq_silhouetteReady",
			"skill": "R6dNhq_skill",
				...
				return (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						(0, react_jsx_runtime.jsxs)("button", {
							...
							}), !enemy && appearance === "original" && (0, react_jsx_runtime.jsxs)("svg", {
