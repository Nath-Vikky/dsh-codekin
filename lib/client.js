window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var tracewild_module_css_default = {
			...
			"close": "dCfysG_close",
			"codekinAttribute": "dCfysG_codekinAttribute",
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: props.state.creatures.map((captured) => {
						...
						return (0, react_jsx_runtime.jsxs)("article", {
							className: `${tracewild_module_css_default.creatureCard} ${tracewild_module_css_default.codekinCard} ${editing && position >= 0 ? tracewild_module_css_default.creatureSelected : ""} ${selectionLocked ? tracewild_module_css_default.codekinSelectionLocked : ""}`,
							children: [
								(0, react_jsx_runtime.jsxs)("span", {
									className: tracewild_module_css_default.codekinNumber,
									children: ["#", String(creature.number).padStart(2, "0")]
								}),
								editing && position >= 0 && (0, react_jsx_runtime.jsx)("span", {
								...
								(0, react_jsx_runtime.jsxs)("button", {
									...
									"aria-pressed": editing ? position >= 0 : void 0,
									"aria-label": editing ? `${creatureName(creature, props.zh)} · ${props.t("squadSelection", { count: props.draft.length })}` : `${creatureName(creature, props.zh)} · ${props.t("codekinDetail")}`,
									onClick: () => {
									...
									children: [
										...
										(0, react_jsx_runtime.jsx)("strong", { children: creatureName(creature, props.zh) }),
										(0, react_jsx_runtime.jsx)("span", {
											className: tracewild_module_css_default.codekinAttribute,
											children: props.t(ECOLOGY_KEYS[creature.ecology])
										}),
										(0, react_jsx_runtime.jsxs)("small", { children: [
