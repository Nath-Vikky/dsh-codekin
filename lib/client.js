window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var tracewild_module_css_default = {
			...
			"signalEffect_breach": "XDFFKW_signalEffect_breach",
			"signalEffect_guard": "XDFFKW_signalEffect_guard",
			"signalEffect_overclock": "XDFFKW_signalEffect_overclock",
			"signalEffect_repair": "XDFFKW_signalEffect_repair",
			"signalEffect_sync": "XDFFKW_signalEffect_sync",
			...
			"turnSignalEffect": "XDFFKW_turnSignalEffect",
			"turnSignalEffectBoss": "XDFFKW_turnSignalEffectBoss",
			"turnSignalIn": "XDFFKW_turnSignalIn",
		...
		function BattleView(props) {
			...
			const [healingReadout, setHealingReadout] = (0, react.useState)();
			...
			const playCascade = async (animation, finalBattle) => {
				...
				for (const frame of animation.frames) {
					...
					} else setHealingReadout(void 0);
					setFallRows(void 0);
					setVisualBoard(frame.before.map((tile) => ({ ...tile })));
					setClearingTiles(new Set(frame.removed));
					setActiveChain(frame.chain);
					await pause(reducedMotion ? 20 : frameEffect?.kind === "repair" ? animation.actor === "boss" ? 340 : 300 : animation.actor === "boss" ? 230 : 190);
					if (animationEpoch.current !== epoch) return;
					if (frameEffect?.kind === "repair" && frameEffect.amount > 0) {
						const actor = animation.actor === "boss" ? "boss" : "player";
						...
						setHealingReadout((value) => value?.key === signalKey ? {
							...value,
							settling: true
						} : value);
			...
			const amplificationSignal = signalReadout !== void 0 && signalReadout.kind !== "repair" && signalReadout.kind !== "guard" ? signalReadout : void 0;
									...
									children: [
										...
										(0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												healingReadout?.actor === "boss" && (0, react_jsx_runtime.jsx)("span", {
													className: `${tracewild_module_css_default.hpHealingBudget} ${healingReadout.settling ? tracewild_module_css_default.hpHealingSettling : ""}`,
													style: {
														left: `${percent(healingReadout.from, battle.wildMaxHp)}%`,
														width: `${percent(healingReadout.to - healingReadout.from, battle.wildMaxHp)}%`
													}
												}, healingReadout.key),
												displayedWildShield > 0 && (0, react_jsx_runtime.jsx)("b", {
										...
										(0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												healingReadout?.actor === "boss" && (0, react_jsx_runtime.jsxs)("em", {
													className: tracewild_module_css_default.hpHealingValue,
													children: ["+", (healingReadout.to - healingReadout.from).toLocaleString()]
												}),
												displayedWildShield > 0 && (0, react_jsx_runtime.jsxs)("span", { children: [
													props.t("shield"),
													" +",
													displayedWildShield.toLocaleString()
												] }),
										...
										children: [
											(0, react_jsx_runtime.jsxs)("div", {
												...
												children: [(0, react_jsx_runtime.jsx)("span", { children: props.t("teamRuntime") }), (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [
														healingReadout?.actor === "player" && (0, react_jsx_runtime.jsxs)("em", {
															className: tracewild_module_css_default.hpHealingValue,
															children: ["+", (healingReadout.to - healingReadout.from).toLocaleString()]
														}),
														displayedPartyShield > 0 && (0, react_jsx_runtime.jsxs)("small", { children: [
															props.t("shield"),
															" +",
															displayedPartyShield.toLocaleString()
														] }),
														(0, react_jsx_runtime.jsxs)("strong", { children: [
											...
											(0, react_jsx_runtime.jsxs)("div", {
												...
												children: [
													...
													healingReadout?.actor === "player" && (0, react_jsx_runtime.jsx)("span", {
														className: `${tracewild_module_css_default.hpHealingBudget} ${healingReadout.settling ? tracewild_module_css_default.hpHealingSettling : ""}`,
														style: {
													...
													displayedPartyShield > 0 && (0, react_jsx_runtime.jsx)("b", {
									...
									children: [
										(0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												amplificationSignal !== void 0 && (0, react_jsx_runtime.jsxs)("span", {
													className: `${tracewild_module_css_default.turnSignalEffect} ${tracewild_module_css_default[`signalEffect_${amplificationSignal.kind}`]} ${amplificationSignal.actor === "boss" ? tracewild_module_css_default.turnSignalEffectBoss : ""}`,
													role: "status",
													"aria-live": "polite",
													children: [
														(0, react_jsx_runtime.jsx)("i", { children: TILE_SYMBOLS[amplificationSignal.ecology] }),
														(0, react_jsx_runtime.jsx)("b", { children: props.t(SIGNAL_EFFECT_KEYS[amplificationSignal.kind]) }),
														amplificationSignal.amount > 0 && (0, react_jsx_runtime.jsxs)("em", { children: ["+", amplificationSignal.amount.toLocaleString()] })
													]
												}, amplificationSignal.key),
