window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var tracewild_module_css_default = {
			...
			"signalEffectBoss": "XDFFKW_signalEffectBoss",
			"signalEffectHud": "XDFFKW_signalEffectHud",
			"signalEffectIn": "XDFFKW_signalEffectIn",
		...
		function BattleView(props) {
			...
			const playCascade = async (animation, finalBattle) => {
				...
				for (const frame of animation.frames) {
					...
					setSignalReadout(frame.signalEffect === void 0 ? void 0 : {
						...frame.signalEffect,
						key: Date.now() + frame.chain,
						actor: animation.actor === "boss" ? "boss" : "player"
					});
									...
									children: [
										...
										(0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												signalReadout !== void 0 && (0, react_jsx_runtime.jsxs)("div", {
													className: `${tracewild_module_css_default.signalEffectHud} ${tracewild_module_css_default[`signalEffect_${signalReadout.kind}`]} ${signalReadout.actor === "boss" ? tracewild_module_css_default.signalEffectBoss : ""}`,
													role: "status",
													"aria-live": "polite",
													children: [
														(0, react_jsx_runtime.jsx)("span", { children: TILE_SYMBOLS[signalReadout.ecology] }),
														(0, react_jsx_runtime.jsx)("strong", { children: props.t(SIGNAL_EFFECT_KEYS[signalReadout.kind]) }),
														(0, react_jsx_runtime.jsx)("b", { children: signalReadout.amount > 0 ? `+${signalReadout.amount.toLocaleString()}` : "MAX" })
													]
												}, signalReadout.key),
												(0, react_jsx_runtime.jsx)("div", {
