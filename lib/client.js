window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var tracewild_module_css_default = {
			...
			"battleUtilityAction": "XDFFKW_battleUtilityAction",
			...
			"brand": "XDFFKW_brand",
			"captureAbandon": "XDFFKW_captureAbandon",
			...
			"skipStageButton": "XDFFKW_skipStageButton",
		...
		function tileLabel(tile, index, t) {
			return `${t(ECOLOGY_KEYS[tile.ecology])}${tile.special === "none" ? "" : ` · ${t(SPECIAL_KEYS[tile.special])}`}${(tile.lockedActions ?? 0) > 0 ? ` · ${t("lockedTile", { actions: tile.lockedActions ?? 0 })}` : ""}${(tile.hazardActions ?? 0) > 0 ? ` · ${t("hazardTile", { actions: tile.hazardActions ?? 0 })}` : ""} · ${Math.floor(index / 7) + 1},${index % 7 + 1}`;
		}
		...
		function BattleView(props) {
			...
			const playCascade = async (animation, finalBattle) => {
				...
				for (const frame of animation.frames) {
					...
					if (animation.actor !== "boss" && frame.damage !== void 0 && frame.totalDamage !== void 0) setDamageReadout({
			...
			const swap = (from, to) => {
				...
				swapTimer.current = window.setTimeout(() => {
					...
					props.act({
						...
						setSwapMotion(void 0);
						const finalBattle = response?.state.battle;
						if (response?.animation !== void 0 && finalBattle?.id === battle.id) await playCascade(response.animation, finalBattle);
					}).finally(() => {
						setClearingTiles(void 0);
						setFallRows(void 0);
						setActiveChain(void 0);
					...
					children: [
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								damageReadout !== void 0 && (0, react_jsx_runtime.jsxs)("div", {
									...
									"aria-live": "polite",
									children: [
										(0, react_jsx_runtime.jsx)("span", { children: props.t("totalDamage") }),
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
									...
									children: [(0, react_jsx_runtime.jsx)("div", {
										...
										children: [
											...
											(0, react_jsx_runtime.jsx)("div", {
												...
												children: (0, react_jsx_runtime.jsx)("i", { style: { width: `${percent(battle.partyHp, battle.partyMaxHp)}%` } })
											}),
										...
										(0, react_jsx_runtime.jsxs)("div", {
											...
											children: [(0, react_jsx_runtime.jsx)("div", {
												...
												children: [
													...
													(0, react_jsx_runtime.jsx)("button", {
														type: "button",
														className: tracewild_module_css_default.captureAbandon,
														disabled: locked,
														onClick: () => {
															props.act({ type: "battle-continue" });
														},
														children: props.t("abandonCapture")
													})
												]
											})]
										}),
								...
								battle.mode === "wild" ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [battle.turnOwner === "player" && !battle.captureWindow && battle.actionsRemaining > 0 && (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: `${tracewild_module_css_default.continueButton} ${tracewild_module_css_default.skipStageButton} ${tracewild_module_css_default.battleUtilityAction}`,
									disabled: locked,
									...
									type: "button",
									className: `${tracewild_module_css_default.continueButton} ${tracewild_module_css_default.battleUtilityAction}`,
									disabled: locked,
									onClick: () => {
										props.act({ type: "battle-continue" });
									},
