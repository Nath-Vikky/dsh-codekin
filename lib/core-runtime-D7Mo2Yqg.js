...
const CODEKIN_ENGINE_VERSION = "0.3.2";
...
const creaturesInEcology = (ecology) => currentEngineContent().creaturesInEcology(ecology);
...
const creatureIdForSignalVariant = (variant) => currentEngineContent().encounterVariantCreatureId(variant);
...
const CORE_CONTENT_REGISTRY = createContentRegistry([CORE_CONTENT_PACK], { engineVersion: CODEKIN_ENGINE_VERSION });
const CORE_CONTENT_VIEW = createContentView(CORE_CONTENT_REGISTRY);
const CORE_ENGINE_CONTENT = createEngineContent(CORE_CONTENT_REGISTRY);
const CORE_CODEKIN_RUNTIME = createCodekinRuntime(CORE_ENGINE_CONTENT);
...
//#endregion
export { PLAYER_QUALITY_GROWTH_BONUSES as $, findFirstLegalBattleSwap as A, MechanicsContractError as At, CAPTURE_HEALTH_RATIO as B, MATCH_BOARD_SIZE as C, EngineContentError as Ct, convertRandomBattleTiles as D, withEngineContent as Dt, chooseBossBattleSwap as E, currentEngineContent as Et, resolveForcedTiles as F, MAX_BONUS_ACTIONS_PER_STAGE as G, MATERIAL_DROP_WEIGHTS as H, BASE_ACTIONS_PER_CREATURE as I, MAX_BOSS_SWAPS_PER_PHASE as J, MAX_BOSS_ACTIONS as K, BASE_BOSS_ACTIONS as L, reshuffleBattleBoard as M, mechanicsContractIssues as Mt, resolveBattleSwap as N, createMatchBoard as O, CODEKIN_MECHANIC_CONTRACTS as Ot, resolveExistingBattleMatches as P, PLAYER_QUALITY_BASE_MULTIPLIERS as Q, BOSS_SKILL_ENERGY_COST as R, MATCH_BOARD_CELLS as S, CODEKIN_ENGINE_VERSION as St, areAdjacentTiles as T, createEngineContent as Tt, MATERIAL_XP as U, CORE_CAPTURE_POWER as V, MAX_ACTIONS_PER_CREATURE as W, MAX_MAP_ENCOUNTERS as X, MAX_CAPTURE_ATTEMPTS as Y, MAX_PLAYER_LEVEL as Z, MAX_TOWER_FLOOR as _, wildLevelFor as _t, applyTraceSignal as a, captureChance as at, towerQualityForFloor as b, wildStats as bt, createInitialTraceWildState as c, encounterLifetimeMs as ct, settleTraceWildIdleRewards as d, playerLevelFactor as dt, PLAYER_QUALITY_MULTIPLIERS as et, towerFloorProfile as f, playerStats as ft, TraceWildRuleError as g, totalXpForLevel as gt, ECOLOGY_ADVANTAGE as h, threatPoints as ht, CORE_ENGINE_CONTENT as i, activeMinuteBand as it, hasBattleMatches as j, assertMechanicsContract as jt, findBestBattleSwap as k, CODEKIN_MECHANIC_OPCODES as kt, expireTraceWildEncounters as l, idleRewardTier as lt, createCodekinRuntime as m, sessionLevel as mt, CORE_CONTENT_REGISTRY as n, WILD_QUALITY_RESISTANCE as nt, applyTraceWildAction as o, coreQualityWeights as ot, normalizeTraceWildAction as p, qualityIndex as pt, MAX_BOSS_BONUS_ACTIONS as q, CORE_CONTENT_VIEW as r, XP_QUALITY_MULTIPLIERS as rt, captureChanceForBattle as s, effectivePartyLevel as st, CORE_CODEKIN_RUNTIME as t, QUALITY_ORDER as tt, restoreTraceWildState as u, levelForXp as ut, emptyTowerMaterialReward as v, wildLevelForRoster as vt, MAX_MATCH_CASCADES as w, QUALITY_SKILL_MULTIPLIERS as wt, towerSkillTierForFloor as x, xpToNextLevel as xt, towerBossStats as y, wildQualityWeights as yt, BOSS_SKILL_ENERGY_LIMIT as z };

//# sourceMappingURL=core-runtime-D7Mo2Yqg.js.map