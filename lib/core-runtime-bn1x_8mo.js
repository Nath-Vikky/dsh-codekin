...
const CODEKIN_ENGINE_VERSION = "0.3.5-alpha.1";
...
//#endregion
export { MAX_PLAYER_LEVEL as $, createMatchBoard as A, CODEKIN_MECHANIC_CONTRACTS as At, BOSS_SKILL_ENERGY_COST as B, towerSkillTierForFloor as C, xpToNextLevel as Ct, areAdjacentTiles as D, createEngineContent as Dt, MAX_MATCH_CASCADES as E, QUALITY_SKILL_MULTIPLIERS as Et, resolveBattleSwap as F, MATERIAL_XP as G, CAPTURE_HEALTH_RATIO as H, resolveExistingBattleMatches as I, MAX_BOSS_ACTIONS as J, MAX_ACTIONS_PER_CREATURE as K, resolveForcedTiles as L, findFirstLegalBattleSwap as M, MechanicsContractError as Mt, hasBattleMatches as N, assertMechanicsContract as Nt, chooseBossBattleSwap as O, currentEngineContent as Ot, reshuffleBattleBoard as P, mechanicsContractIssues as Pt, MAX_MAP_ENCOUNTERS as Q, BASE_ACTIONS_PER_CREATURE as R, towerQualityForFloor as S, wildStats as St, MATCH_BOARD_SIZE as T, EngineContentError as Tt, CORE_CAPTURE_POWER as U, BOSS_SKILL_ENERGY_LIMIT as V, MATERIAL_DROP_WEIGHTS as W, MAX_BOSS_SWAPS_PER_PHASE as X, MAX_BOSS_BONUS_ACTIONS as Y, MAX_CAPTURE_ATTEMPTS as Z, ECOLOGY_ADVANTAGE as _, threatPoints as _t, CORE_ENGINE_CONTENT as a, XP_QUALITY_MULTIPLIERS as at, emptyTowerMaterialReward as b, wildLevelForRoster as bt, captureChanceForBattle as c, coreQualityWeights as ct, restoreTraceWildState as d, idleRewardTier as dt, PLAYER_QUALITY_BASE_MULTIPLIERS as et, settleTraceWildIdleRewards as f, levelForXp as ft, createCodekinRuntime as g, sessionLevel as gt, createCodekinComposition as h, qualityIndex as ht, CORE_CONTENT_VIEW as i, WILD_QUALITY_RESISTANCE as it, findBestBattleSwap as j, CODEKIN_MECHANIC_OPCODES as jt, convertRandomBattleTiles as k, withEngineContent as kt, createInitialTraceWildState as l, effectivePartyLevel as lt, normalizeTraceWildAction as m, playerStats as mt, CORE_CODEKIN_RUNTIME as n, PLAYER_QUALITY_MULTIPLIERS as nt, applyTraceSignal as o, activeMinuteBand as ot, towerFloorProfile as p, playerLevelFactor as pt, MAX_BONUS_ACTIONS_PER_STAGE as q, CORE_CONTENT_REGISTRY as r, QUALITY_ORDER as rt, applyTraceWildAction as s, captureChance as st, CORE_CODEKIN_COMPOSITION as t, PLAYER_QUALITY_GROWTH_BONUSES as tt, expireTraceWildEncounters as u, encounterLifetimeMs as ut, TraceWildRuleError as v, totalXpForLevel as vt, MATCH_BOARD_CELLS as w, CODEKIN_ENGINE_VERSION as wt, towerBossStats as x, wildQualityWeights as xt, MAX_TOWER_FLOOR as y, wildLevelFor as yt, BASE_BOSS_ACTIONS as z };

//# sourceMappingURL=core-runtime-bn1x_8mo.js.map